...
const items = [
  { id: 0, articleLabel: 'Капустяні', to: '/test', picturePath: '/images/categories/kapustiani.jpg' },
  { id: 1, articleLabel: 'Бобові', to: '/test', picturePath: '/images/categories/bobovi.jpg' },
  { id: 2, articleLabel: 'Бульбоплоди', to: '/test', picturePath: '/images/categories/bulboplody.jpg' },
  { id: 3, articleLabel: 'Коренеплоди', to: '/test', picturePath: '/images/categories/koreneplody.jpg' },
  { id: 4, articleLabel: 'Пасльонові', to: '/test', picturePath: '/images/categories/paslionovi.jpg' },
  {
    id: 5,
    articleLabel: 'Пряно смакові рослини',
    to: '/test',
    picturePath: '/images/categories/priano-smakovi-roslyny.jpg',
  },
  { id: 6, articleLabel: 'Розсада', to: '/test', picturePath: '/images/categories/vyroschuvannia-rozsady.jpg' },
  { id: 7, articleLabel: 'Салатні', to: '/test', picturePath: '/images/categories/salatni.jpg' },
  { id: 8, articleLabel: 'Цибулеві', to: '/test', picturePath: '/images/categories/tsybulevi.jpg' },
  { id: 9, articleLabel: 'Гарбузові', to: '/test', picturePath: '/images/categories/harbuzovi.jpg' },
  { id: 10, articleLabel: 'Ягідні', to: '/test', picturePath: '/images/categories/yahidni-roslyny.jpg' },
  { id: 11, articleLabel: 'template-200x200', to: '/test', picturePath: '/images/categories/template-200x200.jpg' },
  { id: 12, articleLabel: 'fallback-200x200', to: '/test', picturePath: '/images/fallback/fallback-200x200.jpg' },
  { id: 13, articleLabel: 'Капустяні 14', to: '/test', picturePath: '/images/categories/kapusta-bilokachanna.jpg' },
  { id: 14, articleLabel: 'Капустяні 15', to: '/test', picturePath: '/images/categories/kapustiani.jpg' },
];
